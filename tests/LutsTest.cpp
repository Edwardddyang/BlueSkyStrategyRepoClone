...
TEST_F(LutsTest, BasicLutTest) {
  std::filesystem::path power_factor_path =
      LutsTest::strat_root_path / "data/luts/TestData/power_factor.csv";
...
TEST_F(LutsTest, EffLutTest) {
  std::filesystem::path roll_res_yint_path =
      LutsTest::strat_root_path / "data/luts/TestData/rr1.csv";
  ...
  std::filesystem::path roll_res_slope_path =
      LutsTest::strat_root_path / "data/luts/TestData/rr2.csv";
...
TEST_F(LutsTest, ForecastLutTest) {
  std::filesystem::path dni_path =
      LutsTest::strat_root_path / "data/luts/TestData/dni.csv";
  ...
  std::filesystem::path dhi_path =
      LutsTest::strat_root_path / "data/luts/TestData/dhi.csv";
