function [sCells] = remShadCellStruc(sunPlane,canopyMesh, cellMeshes, cellPoints,idx)
    % Remove shaded triangles of a specific array cell
    % Parameters:
    % sunPlane:   2 member struct describing plane of the sun. See
    %             create_sun_plane() for details
    % canopyMesh: opcode mesh of the canopy. "none" for no canopy simulation
    % cellMeshes: Ordered cell array of opcode meshes of each array cell
    % cellPoints: An ordered cell array of n x 3 matrices describing triangle
    %             makeup of each array cell
