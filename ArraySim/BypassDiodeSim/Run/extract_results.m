function [] = extract_results(outCsv, resultCsv, numFolders, numRows, offset)
...
% @param resultCsv: Output csv name
% @param numFolders: Number of folders
% @param numRows: Number of positions simulated
% @param offset: Extract a continuous subset of rows
  ...
  for iDir = 1:numFolders
    ...
    result(start_index+offset:end_index+offset) = diode_csv(start_index+offset:end_index+offset);
